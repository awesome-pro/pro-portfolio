    ...
    skills: [
      {
        ...
        details:
          'Streaming SSR, ISR, SSG, Edge Runtime, Caching strategies.',
        projects: 'Frontend',
      ...
      },
      {
        ...
        experience: '1.5 years',
        details:
          'Render optimization, Suspense patterns, React Server Actions',
        projects: 'Large-scale E-commerce',
    ...
    skills: [
      {
        ...
        experience: '1.5 years',
        details:
          'Runtime schedulers, Concurrency patterns, CQRS, Dependecy Injection',
      ...
      },
      {
        ...
        experience: '1.5 years',
        details:
          'Async IO optimization, WebSocket implementations, High-performance data streaming.',
    ...
    skills: [
      {
        ...
        experience: '1+ years',
        details:
          'Query optimization, Partitioning strategies, ACID compliance patterns',
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        level: 'Intermediate',
        experience: '1 year',
        details: 'Compute Engine, Cloud SQL, Cloud Storage, Cloud Run',
        projects: 'Cloud Infrastructure, Container orchestration',
      ...
      },
      {
        ...
        level: 'Advanced',
        experience: '1 year',
        details: 'EC2, SES, S3, Lambda, ECS deployment',
